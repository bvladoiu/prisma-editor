# DONE
Task1: Add an always visible floating action button with an edit icon to the Editor object (not Page or Home).
...
#DRAFTS
Add site and language properties to the Editor object. open them in a bottom drawer and allow user to edit them from there.when user presses the edit fab. Change the icon on the fab to save and save them. Look at commit/set/load apis in regular components for details
